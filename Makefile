...
bcaine-format-%.tgz : src/bcaine/format.sld src/bcaine/format.scm
...
package : bcaine-misc-util-%.tgz bcaine-format-%.tgz bcaine-sld-stub-expand-0.0.1.tgz bcaine-obj-0.0.1.tgz bcaine-defstruct-0.0.1.tgz
